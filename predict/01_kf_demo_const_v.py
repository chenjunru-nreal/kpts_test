...
kalman = cv2.KalmanFilter(4,2)  # state_size, meas_size

"""
 x y vx vy
[1,0,0, 0]  x  ( meas = measureMatrix * state )
[0,1,0, 0]  y
"""
...
x y vx vy
[1,0,1,0]  x
[0,1,0,1]  y  (transition Matrix represent mathmatics model)
[0,0,1,0]  vx (this is a constant speed motion )
[0,0,0,1]  vy
"""
...
kalman.processNoiseCov = np.eye(4, dtype=np.float32)*0.003
